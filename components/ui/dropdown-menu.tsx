...
function DropdownMenuItem({
  ...
  return (
    <DropdownMenuPrimitive.Item
      ...
      className={cn(
        "relative flex cursor-pointer items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium",
        "outline-none select-none transition-all duration-200",
        "text-gray-700 dark:text-gray-300",
        "hover:bg-[#009688]/10 hover:text-[#009688] dark:hover:bg-[#009688]/20 dark:hover:text-teal-400",
        "focus:bg-[#009688]/10 focus:text-[#009688] dark:focus:bg-[#009688]/20 dark:focus:text-teal-400",
        ...
        "data-[variant=destructive]:hover:text-red-700 dark:data-[variant=destructive]:hover:text-red-300",
...
function DropdownMenuCheckboxItem({
  ...
  return (
    <DropdownMenuPrimitive.CheckboxItem
      ...
      className={cn(
        "relative flex cursor-pointer items-center gap-3 rounded-lg py-2.5 pr-3 pl-10 text-sm font-medium",
        "outline-none select-none transition-all duration-200",
        "text-gray-700 dark:text-gray-300",
        "hover:bg-[#009688]/10 hover:text-[#009688] dark:hover:bg-[#009688]/20 dark:hover:text-teal-400",
        "focus:bg-[#009688]/10 focus:text-[#009688] dark:focus:bg-[#009688]/20 dark:focus:text-teal-400",
    ...
    >
      <span className="pointer-events-none absolute left-3 flex size-4 items-center justify-center">
        <DropdownMenuPrimitive.ItemIndicator>
          <CheckIcon className="size-4 text-[#009688] dark:text-teal-400 font-bold" />
        </DropdownMenuPrimitive.ItemIndicator>
      </span>
      {children}
    </DropdownMenuPrimitive.CheckboxItem>
...
function DropdownMenuRadioItem({
  ...
  return (
    ...
    >
      <span className="pointer-events-none absolute left-3 flex size-4 items-center justify-center">
        <DropdownMenuPrimitive.ItemIndicator>
          <CircleIcon className="size-2.5 fill-[#009688] dark:fill-teal-400" />
        </DropdownMenuPrimitive.ItemIndicator>
      </span>
      {children}
    </DropdownMenuPrimitive.RadioItem>
  ...
  return (
    <DropdownMenuPrimitive.SubTrigger
      ...
      className={cn(
        ...
        "hover:bg-[#009688]/10 hover:text-[#009688] dark:hover:bg-[#009688]/20 dark:hover:text-teal-400",
        "focus:bg-[#009688]/10 focus:text-[#009688] dark:focus:bg-[#009688]/20 dark:focus:text-teal-400",
        "data-[state=open]:bg-[#009688]/10 data-[state=open]:text-[#009688] dark:data-[state=open]:bg-[#009688]/20 dark:data-[state=open]:text-teal-400",
        "data-[inset]:pl-10",
        "[&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        "[&_svg:not([class*='text-'])]:text-gray-500 dark:[&_svg:not([class*='text-'])]:text-gray-400",
        className
