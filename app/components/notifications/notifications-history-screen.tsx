...
const NotificationCard: React.FC<NotificationCardProps> = ({ notification }) => {
  ...
  return (
    <div className="w-full rounded-xl border border-gray-200 bg-white shadow-sm hover:shadow-md transition-shadow p-4 md:p-5 flex flex-col gap-3">
      <div className="flex items-start justify-between gap-3">
        <div className="flex items-start gap-3">
          ...
          <div>
            <h3 className="text-sm md:text-base font-semibold text-[#344054]">
              {notification.title}
            </h3>
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 pt-2 border-t border-gray-100 mt-1">
        <div className="flex flex-wrap items-center gap-3 text-xs md:text-sm text-[#475467]">
        ...
        <span className="text-xs md:text-sm text-[#475467]">
    ...
    <div className="w-full h-full bg-white dark:bg-gray-950">
      <div className="max-w-5xl mx-auto px-4 py-6 md:py-8">
        <div className="flex items-start justify-between gap-4 mb-6">
          <div>
            <h1 className="text-lg md:text-xl font-semibold text-[#344054]">
        ...
        {notifications.length === 0 ? (
          <div className="flex flex-col items-center justify-center h-64 gap-3 border border-dashed border-gray-200 rounded-xl bg-gray-50">
            ...
            <p className="text-xs text-[#475467] max-w-sm text-center">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between pt-4 border-t border-gray-100">
              <p className="text-xs md:text-sm text-[#475467]">
                Showing{' '}
                <span className="font-medium text-[#344054]">
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="px-3 py-1.5 rounded-lg border border-gray-200 text-xs md:text-sm text-[#475467] hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
                >
                  Previous
                </button>
                <span className="text-xs md:text-sm text-[#475467]">
                  Page{' '}
                  <span className="font-medium text-[#344054]">{page}</span> of{' '}
                  <span className="font-medium text-[#344054]">
                    {totalPages}
                  </span>
                </span>
