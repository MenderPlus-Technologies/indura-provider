            ...
            <div className="space-y-4">
              {paymentMethods.map((method, index) => (
                ...
                >
                  ...
                  <div className="flex items-center justify-center w-12 h-8 bg-white border border-gray-200 rounded">
                    {method.type === 'VISA' ? (
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-14 pr-4 py-3 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-teal-500 focus:border-transparent outline-none"
                />
              </div>
            </div>
          </div>
